...
public class ReceiptpaymentDTO {
    ...
    public ReceiptpaymentDTO(Long id, String invoiceid, String ordertype, String customerdisplayname_id, String description, String createddate,
			String createdby, String paymentmethod, String deposital, String amount, Long invoice_id) {
		super();
		this.id = id;
