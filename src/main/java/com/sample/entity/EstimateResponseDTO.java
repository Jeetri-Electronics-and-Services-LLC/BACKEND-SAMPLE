...
public class EstimateResponseDTO {
    ...
    private List<EstimateProductDetailResponseDTO> estimateProductDetails;
    private List< EstimateWithoutTaxResponseDTO>  estimateWithoutTax;
	...
	public List<EstimateProductDetailResponseDTO> getEstimateProductDetails() {
		return estimateProductDetails;
	}


	public void setEstimateProductDetails(List<EstimateProductDetailResponseDTO> estimateProductDetails) {
		this.estimateProductDetails = estimateProductDetails;
	}


	public List<EstimateWithoutTaxResponseDTO> getEstimateWithoutTax() {
		return estimateWithoutTax;
	}


	public void setEstimateWithoutTax(List<EstimateWithoutTaxResponseDTO> estimateWithoutTax) {
